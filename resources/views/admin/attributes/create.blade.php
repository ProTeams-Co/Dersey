...
@section('content')
    <x-admin.page
        :title="__('admin.attributes.create_title')"
        :breadcrumbs="[
            ...
            ['label' => __('admin.attributes.create_title')],
        ]"
    >
        <x-admin.form :action="route('admin.attributes.store')" translatable class="max-w-2xl space-y-6">
