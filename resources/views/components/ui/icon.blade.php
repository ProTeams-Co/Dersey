...
@php
    /**
     * A small fixed lookup of lucide-style paths (24x24, stroke-based) -
     * same "copy the SVG markup directly, no JS icon library" approach as
     * ui/alert.blade.php, just centralized here instead of repeated inline
     * per call site.
     */
    $icons = [
        ...
        'arrow-start' => '<path d="m12 19-7-7 7-7"/><path d="M19 12H5"/>',
